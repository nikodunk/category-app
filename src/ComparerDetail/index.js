        ...
        <div >
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <hr />
                    <a class="btn btn-info" target="_blank" href="{props.item.sustlink}">Sustainability & Ethics</a>
                    <a target="_blank" class="btn btn-success" href="{props.item.productlink}">Get It Now</a>
