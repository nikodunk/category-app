...
@Component({
  selector: 'app-skincare-comparer',
  templateUrl: './skincare-comparer.component.html',
  styleUrls: ['./skincare-comparer.component.css']
})
export class SkincareComparerComponent implements OnInit {
